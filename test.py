...
# ------------------ ПАРАМЕТРИ ФІЗИКИ ------------------
PHYSICS = {
    "diffuse_strength": 0.6,      # сила хаотичного (теплового) руху
    "bond_distance": 70,          # максимальна відстань для створення зв’язку
    "bond_break_distance": 180,   # відстань, після якої зв’язок розривається
